...
// Inline icons (since lucide-react not installed yet)
...
export function AnimatedCharactersLoginPage({
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-brand-purple/90 via-brand-purple to-brand-purple/80 p-12 text-white">
        <div className="relative z-20">
          <a href="/" className="flex items-center gap-3 text-lg font-semibold hover:opacity-80 transition-opacity">
            <img
              src="/images/logo-white.png"
              alt="HardRock"
              className="h-8 w-auto"
            />
            <span className="text-4xl ml-8">Login Page</span>
          </a>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="lg:hidden flex flex-col items-center justify-center mb-12">
            ...
            <span className="text-3xl font-semibold mt-3 text-foreground">Login Page</span>
          </div>
          ...
          {/* Mobile Footer Links */}
          <div className="lg:hidden flex items-center justify-center gap-6 mt-10 text-sm text-muted-foreground">
