...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:image" content="https://hardrock-co.com/images/og-image.webp">
        ...
        <meta property="twitter:image" content="https://hardrock-co.com/images/og-image.webp">
